...
app = Flask(__name__)
app.secret_key = "e3fa4d7a19ce0f3787435c5f9fb577efaaea930e1ad7a3729bba245fc8ebbfe1"  # Replace with your own secret key, needed for session management
...
def hypothesis_test():
    ...
    if p_value <= 0.0001:
        fun_message = "Congrats! Low p-value = high significance"
    else:
        fun_message = None
    ...
    plt.axvline(observed_stat, color='red', linestyle='dashed', linewidth=2, label=f'Observed {parameter}: {observed_stat:.4f}')
